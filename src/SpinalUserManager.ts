...
export class SpinalUserManager {
  ...
  public static get_user_id(options, user_name, password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static get_admin_id(options, admin_name, password, success_callback, error_callback = null) {
    var get_cmd;
    // Access: /get_user_id?u=<user>&p=<password>
  ...
  public static new_account(options, user_name, password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static change_password(options, user_id, password, new_password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static delete_account(options, user_id, password, success_callback, error_callback = null) {
  ...
  public static change_password_by_admin(options, username, password, admin_id, admin_password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static delete_account_by_admin(options, username, admin_id, admin_password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static change_account_rights_by_admin(options, username, right, admin_id, admin_password, success_callback, error_callback = null) {
    var get_cmd;
  ...
  public static send_xhr(options, get_cmd, success_callback, error_callback) {
    var path, xhr_object;
    path = "";
  ...
  public static _if_error(error_callback, fun, response) {
